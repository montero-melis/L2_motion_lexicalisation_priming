...
#### Speakers and items as random effects (intercept + slope)
...
```{r, fig.height = myfighe, fig.width = myfigwi, results = 'hide'}
...
#### Speakers and items as random smooths
...
We saw above that random intercepts by items made sense, but not random slopes.
We add the former but not the latter -- and not factor smooths by items either
...
# show by-speaker random smooths
# plot(fm_p3, all.terms = T, rug = FALSE)
```


```{r, fig.height = myfighe, fig.width = myfigwi, echo = FALSE, results = 'hide'}
# set same y-axes for both
myylim1 <- c(-1.5, 5)
myylim2 <- c(-1, 4.5)
par(mfrow = c(2, 2))
...
# Native speakers
plot_smooth(fm_p3, view = 'Trial', cond = list(GroupCondit = 'NS.Control'),
            col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
            main = 'NS: Path-primed vs Control')
plot_smooth(fm_p3, view = 'Trial', cond = list(GroupCondit = 'NS.Path'),
            col = 'blue', rm.ranef=TRUE, add = TRUE)
# L2 speakers
plot_smooth(fm_p3, view = 'Trial', cond = list(GroupCondit = 'L2.Control'),
            col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
            main = 'L2: Path-primed vs Control')
plot_smooth(fm_p3, view = 'Trial', cond = list(GroupCondit = 'L2.Path'),
            col = 'blue', rm.ranef=TRUE, add = TRUE)

# and more to the point
plot_diff(fm_p3, view = 'Trial', comp = list(GroupCondit = c('NS.Path', 'NS.Control')),
          ylim = myylim2, rm.ranef=TRUE)
plot_diff(fm_p3, view = 'Trial', comp = list(GroupCondit = c('L2.Path', 'L2.Control')),
          ylim = myylim2, rm.ranef=TRUE)
par(mfrow = c(1, 1))
```
...
```{r, fig.height = myfighe, fig.width = myfigwi}
# # set same y-axis for both
# myylim1 <- c(-6, 3.5)
# myylim2 <- c(-0.5, 8)
# par(mfrow = c(2, 2))
...
# Native speakers
plot_smooth(fm_m3, view = 'Trial', cond = list(GroupCondit = 'NS.Control'),
            col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
            main = 'NS: Manner-primed vs Control')
plot_smooth(fm_m3, view = 'Trial', cond = list(GroupCondit = 'NS.Manner'),
            col = 'blue', rm.ranef=TRUE, add = T)
# L2 speakers
plot_smooth(fm_m3, view = 'Trial', cond = list(GroupCondit = 'L2.Control'),
            col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
            main = 'L2: Manner-primed vs Control')
plot_smooth(fm_m3, view = 'Trial', cond = list(GroupCondit = 'L2.Manner'),
            col = 'blue', rm.ranef=TRUE, add = T)

# and more to the point
plot_diff(fm_m3, view = 'Trial', comp = list(GroupCondit = c('NS.Manner', 'NS.Control')),
          ylim = myylim2, rm.ranef=TRUE)
plot_diff(fm_m3, view = 'Trial', comp = list(GroupCondit = c('L2.Manner', 'L2.Control')),
          ylim = myylim2, rm.ranef=TRUE)
```
...
summary(fm_p_prof9)
# plot(fm_p_prof9, all.terms = TRUE, rug = FALSE)
```
...
myylim1 <- c(-5, 8)
for(cloze in seq(6, 36, length.out = 6)) {
  plot_smooth(fm_p_prof9, view = 'Trial',
              cond = list(Condition = 'Control', ClozeScore = cloze),
              col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
              main = paste('Path-primed and Control; cloze =', cloze))
  plot_smooth(fm_p_prof9, view = 'Trial',
              cond = list(Condition = 'Path', ClozeScore = cloze),
              col = 'blue', rug = FALSE, rm.ranef=TRUE, add = TRUE)
}
...
summary(fm_m_prof9)
plot(fm_m_prof9, all.terms = TRUE, rug = FALSE)
```
...
myylim1 <- c(-6, 4.5)
for(cloze in seq(6, 36, length.out = 6)) {
  plot_smooth(fm_m_prof9, view = 'Trial',
              cond = list(Condition = 'Control', ClozeScore = cloze),
              col = 'red', rug = FALSE, ylim = myylim1, rm.ranef=TRUE,
              main = paste('Manner-primed and Control; cloze =', cloze))
  plot_smooth(fm_m_prof9, view = 'Trial',
              cond = list(Condition = 'Manner', ClozeScore = cloze),
              col = 'blue', rug = FALSE, rm.ranef=TRUE, add = TRUE)
}
# difference plot in 3D
par(mfrow = c(1, 1))
plot_diff2(fm_m_prof9, view = c('Trial', 'ClozeScore'), 
           comp = list(Condition = c('Manner', 'Control')),
           rm.ranef = TRUE)
```
