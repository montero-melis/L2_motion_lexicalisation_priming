...
plot_NS_L2 <- function(fm, primed_cond = NULL, ylim1 = NULL, ylim2 = NULL) {
  par(mfrow = c(2, 2))
  mycex <- 0.9
  ...
  plot_smooth(fm, view = 'Trial', cond = list(GroupCondit = 'NS.Control'),
              ...
              main = 'Native speakers', ylab = paste(primed_cond, "verb"),
              hide.label = TRUE)
  # plot NS primed
  ...
  plot_smooth(fm, view = 'Trial', cond = list(GroupCondit = 'L2.Control'),
              col = 'blue', lty = 2, rug = FALSE, ylim = ylim1, rm.ranef = TRUE,
              main = 'L2 speakers', ylab = paste(primed_cond, "verb"),
              hide.label = TRUE)
  # L2 speakers primed
  ...
  plot_diff(fm, view = 'Trial', comp = list(GroupCondit = c(NS_primed, 'NS.Control')),
            ...
            ylab = paste('Difference in', primed_cond, "verb"), hide.label = TRUE)
...
plot_L2_profic <- function(fm, primed_cond = NULL, ylim1 = NULL,
                           cloze_range = c(6, 36)) {
  ...
  for(cloze in cloze_scores) {
    plot_smooth(fm, view = 'Trial', cond = list(Condition = 'Control', ClozeScore = cloze),
                col = 'blue', lty = 2, rug = FALSE, ylim = ylim1, rm.ranef = TRUE,
                hide.label = TRUE, ylab = paste(primed_cond, "verb"),
...
Previous models showed that random **intercepts** by items made sense, but not random slopes.
...
plot_NS_L2(fm_p3, primed_cond = 'Path', ylim1 =  c(-1.5, 5.5), ylim2 = c(-1, 4.5))
```
...
```{r, fig.height = myfighe, fig.width = myfigwi, echo = FALSE, results = 'hide'}
plot_NS_L2(fm_m3, primed_cond = 'Manner', ylim1 = c(-4, 3.5), ylim2 = c(-.5, 6))
```
...
plot_L2_profic(fm_p_prof9, primed_cond = 'Path', ylim1 = c(-5, 8))
```
...
```{r, fig.height= 6, fig.width=9, results='hide'}
plot_L2_profic(fm_m_prof9, primed_cond = 'Manner', ylim1 = c(-6, 4.5))
```
