...
plot_basel(glmm_basel, d_basel, nb_sims = 500)  # Adjust nb_sims (TO DO)
```


```{r}
# save to disk for thesis chapter
tiff(file = "figures/glmm_baseline.tiff", width = 4, height = 3, units = "in", pointsize = 10, res = 800)
plot_basel(glmm_basel, d_basel, nb_sims = 1000)  # Adjust nb_sims (TO DO)
dev.off()
```
...
plot_diff2(gam_l2prof, view = c("Trial", "ClozeScore"),
           ...
           plotCI=TRUE, rm.ranef=TRUE, main="Adults-Children")
```
...
```{r}
# Path verb comparison
tiff(file = "figures/gam_L2_prof_singlemodel_path.tiff", width = mywidth_prof_plots, 
     height = myheight_prof_plots, units = "in", pointsize = mypointsize_prof_plots, res = 800)
plot_L2_profic_singlemodel(gam_l2prof, primed_cond = 'Path')
dev.off()
# Manner verb comparison
tiff(file = "figures/gam_L2_prof_singlemodel_manner.tiff", width = mywidth_prof_plots, 
     height = myheight_prof_plots, units = "in", pointsize = mypointsize_prof_plots, res = 800)
plot_L2_profic_singlemodel(gam_l2prof, primed_cond = 'Manner')
dev.off()
```
...
```{r}
# Path verb comparison
tiff(file = "figures/gam_L2_prof_singlemodel_diff_path.tiff", width = mywidth_prof_plots, 
     height = myheight_prof_plots, units = "in", pointsize = mypointsize_prof_plots, res = 800)
plot_L2_profic_diff_singlemodel(gam_l2prof, primed_cond = "Path")
dev.off()
# Manner verb comparison
tiff(file = "figures/gam_L2_prof_singlemodel_diff_manner.tiff", width = mywidth_prof_plots, 
     height = myheight_prof_plots, units = "in", pointsize = mypointsize_prof_plots, res = 800)
plot_L2_profic_diff_singlemodel(gam_l2prof, primed_cond = "Manner")
dev.off()
```
