...
Further processing and adjustments:
...
# Variation to output a number instead of string
dev_expl2 <- function(fm) {
  devi <- summary(fm)$dev.expl
  round(100 * devi, 1)
}
...
### GAMM analysis -- single-model approach
...
### Adaptation to path verbs vs proficiency (two-models approach)
...
### Adaptation to manner verbs vs proficiency (two-models approach)
